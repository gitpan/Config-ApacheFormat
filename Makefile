# This Makefile is for the Config::ApacheFormat extension to perl.
#
...
#	ABSTRACT_FROM => q[ApacheFormat.pm]
#	AUTHOR => q[Sam Tregar <sam@tregar.com>]
#	NAME => q[Config::ApacheFormat]
#	PREREQ_PM => { Class::MethodMaker=>q[1.08], Scalar::Util=>q[1.07], File::Spec=>q[0.82], Text::Balanced=>q[1.89], Carp=>q[0] }
#	VERSION_FROM => q[ApacheFormat.pm]
...
DISTNAME = Config-ApacheFormat
NAME_SYM = Config_ApacheFormat
VERSION = 1.0
VERSION_SYM = 1_0
XS_VERSION = 1.0
INST_BIN = blib/bin
...
MAKEMAKER = /usr/local/lib/perl5/5.6.1/i686-linux/ExtUtils/MakeMaker.pm
MM_VERSION = 5.45
...
FULLEXT = Config/ApacheFormat
BASEEXT = ApacheFormat
PARENT_NAME = Config
DLBASE = $(BASEEXT)
...
TO_INST_PM = ApacheFormat.pm

PM_TO_BLIB = ApacheFormat.pm \
	$(INST_LIBDIR)/ApacheFormat.pm
...
manifypods : pure_all ApacheFormat.pm
	@$(POD2MAN) \
	ApacheFormat.pm \
	$(INST_MAN3DIR)/Config::ApacheFormat.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f  $(INST_LIBDIR)/ApacheFormat.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Config-ApacheFormat\" VERSION=\"1,0,0,0\">\n}. qq{\t<TITLE>Config-ApacheFormat</TITLE>\n}. qq{\t<ABSTRACT>use Apache format config files</ABSTRACT>\n}. qq{\t<AUTHOR>Sam Tregar &lt;sam\@tregar.com&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Carp\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Class-MethodMaker\" VERSION=\"1,08,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"File-Spec\" VERSION=\"0,82,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Scalar-Util\" VERSION=\"1,07,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Text-Balanced\" VERSION=\"1,89,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i686-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Config-ApacheFormat.ppd
